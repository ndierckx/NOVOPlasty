                    ...
                    if ($check_repetitive21 > 6)
                    {
                        ...
                        if ($y > $startprint2)
                        {
                            print OUTPUT5 "DETECT_REPETITIVE2\n";
                                ...
                                {
                                    my $read_end_AT = substr $read_short_end2, -$read_length+$overlap;
                                    ...
                                    if ($A_rich_test > $read_length-$overlap-3 || $T_rich_test > $read_length-$overlap-3 || $G_rich_test > $read_length-$overlap-3 || $C_rich_test > $read_length-$overlap-3)
                                    {
                                        $AT_rich = "yes";
                                        goto FINISH;
                                    }
...
NUCLEO:     while ($l < $read_length - ($overlap+$left-1) + $extra_l)
            {
                ...
                if ($SNR_read ne "" && $l > 0 && $check_before_end eq "")
                {
                    ...
                    if ($y > $startprint2)
                    {
                        print OUTPUT5 $best_extension_tmp8." EXT_TMP8\n";
                    }
            ...
            {               
                ...
                if ($before eq "yes")
                {
                    if ((length($best_extension2) < 3 || (length($best_extension2) < 6 && ($ext > 15 || $SNR_read ne ""))) && $repetitive_detect ne "yes" && $before eq "yesss")
                    {
                        if ($y > $startprint2)
                        {
            ...
            elsif ($split eq "yes5")
            {
                ...
                if ($before eq "yes")
                {
                    if ((length($best_extension1) < 3 || (length($best_extension1) < 6 && ($ext > 15 || $SNR_read ne ""))) && $repetitive_detect ne "yes" && $repetitive_detect eq "yesff")
                    {               
                        if ($y > $startprint2)
                        {
                ...
                if ($SNP_active eq "yes" && ($before eq "yes" || $extensions_before eq "yes") && $count_split eq '2' && $SNR_read eq "yes")
                {
                    my @chars;
                    my @chars2;
                    undef @chars;
...
INDELa:                
                if ($last_chance ne "yes" && $before eq "yes" && $indel_split_skip ne "yes" && $ext_total > 15 && ($delete_first ne "yes" || (length($best_extension1) < 5 && length($best_extension2) < 5)) && $indel_split < ($read_length-25 -$overlap))
                {
                    delete $seed{$id};
...
BEFORE:
                    ...
                    $s = '0';
                    $before_split = substr $read_short_end2, -($read_length-$left-1), $right+$overlap;
                    my $star3 = '0';
                    if ($containX_short_end2 > 0)
                    {
...
print OUTPUT5 $count_all." COUNT_ALL\n";
                    ...
                    elsif($count_all < 3 && $overhang < $read_length-($overlap+15))
                    {
                        if ($y > $startprint2)
                        {
                            print OUTPUT5 "\nMAKE BEFORE SHORTER\n\n";
...
FILTER_4:                       foreach my $line (keys %hash_read_short_end)
                            ...
                            elsif (($count1b+$count2b+$count3b+$count4b) < 10 && $overhang < $read_length-($overlap*1.5) && $before_shorter_skip ne "yes")
                            {
                                if ($y > $startprint2)
                                {
...
REP_CHECK0:                         foreach my $exts (keys %extensions_original)
                ...
                if ($last_chance ne "yes" && $SNP_active eq "" && $contig_end ne "yes" && $indel_split_skip ne "yes" && ($delete_first ne "yes" || (length($best_extension1) < 5 && length($best_extension2) < 5)) && $ext_total > 18 && $indel_split < ($read_length-25 -$overlap))
                {
                    $best_extension = "";
                ...
                elsif (($SNP_active eq "" || ($extensions_before eq "yes" && $deletion ne "yes")) && $contig_end ne "yes" && ($delete_first ne "yes" || (length($best_extension1) < 5 && length($best_extension2) < 5)) && $deletion ne "yes")
                {
                    $best_extension = "";
                    if ($y > $startprint2)
                    {
                ...
                elsif ($jump_rep ne "yes" && $repetitive_detect eq "yes")
                {
                    if ($y > $startprint2)
                    {
                        print OUTPUT5 "JUMP REP\n";
                ...
                elsif($delete_first ne "yes" && $deletion ne "yes")
                {            
                    if (exists $old_id{$id} && ($noback eq "stop" || $position_back >= ($insert_size*3)) && $position > 1000 )
                    {                                     
                        $merge_read_length = length ($read);
...
EXTEND_READ:
                                            ...
                                            elsif ($use_regex eq "yes" && $last_chance ne "yes")
                                            {
                                                $read_new = $read;
                                                delete $last_chance{$id};
                                                $last_chance{$id} = "yes";
                ...
                while ($n < length($match)-($overlap+1))
                {
                    ...
                    {                             
                        ...
                        foreach my $line (keys %read_start)
                        {
                            ...
                            {
                                $found_seq = $match2 =~ s/(.)$read_start_sub/$1+/;
                                if ($found_seq > 0)
                                {
                                    my @ext = split /\+/, $match2;
...
NUCLEO_BACK: while ($l < $read_length - ($overlap+$left-1) + $extra_l)
             {
                ...
                my $c = '2.8';
                if ($ext > 6 && $type ne "chloro" && $SNR_read_back eq "")
                {
                    $c = '5';
                }
                if ($ext > 22 && $SNR_read eq "")
                ...
                if ($ext > 6 && $type eq "chloro" && $SNR_read_back eq "")
                {
                    $c = '5';
                }
            ...
            {  
                ...
                if ((length($best_extension2) < 3 || (length($best_extension2) < 6 && $ext > 15)) && $repetitive_detect_back ne "yes" && $before_back eq "yesss")
                {
                    if ($y > $startprint2)
                    {
...
INDEL_BACKa:  
                if ($last_chance_back ne "yes" && (($SNP_active_back eq "" && $before_back eq "yes") || $extensions_before eq "yes") && $indel_split_skip_back ne "yes" && $ext_total_back > 15 && ($delete_first ne "yes_back" || (length($best_extension1) < 5 && length($best_extension2) < 5)) && $indel_split_back < ($read_length-25 -$overlap))
                {
                    delete $seed{$id};
                    delete $seed{$id_split1};
                    delete $seed{$id_split2};
                ...
                elsif ((($before_back eq "yes" && $SNP_active_back eq "") || $extensions_before eq "yes") && ($delete_first ne "yes_back" || (length($best_extension1) < 5 && length($best_extension2) < 5 && length($best_extension3) < 5 && length($best_extension4) < 5)))
                {
                    delete $seed{$id};
                    delete $seed{$id_split1};
                    delete $seed{$id_split2};
                ...
                elsif (($before_back eq "yes" || $extensions_before eq "yes") && ((length($best_extension1) < 5 && length($best_extension2) < 5) || $delete_first ne "yes_back"))
                {
                    if ($y > $startprint2)
                    {
...
print OUTPUT5 $count_all." COUNT_ALL\n";
                    ...
                    else
                    {
                        ...
                        elsif ($morethan3 > 0 && length($read) > $insert_size)
                        {
                            ...
                            my $read_short_start_tempie = substr $read, ($insert_size-$read_length) - ((($insert_size*1.65)-$insert_size)/2) - $overhang, ($insert_size*1.65)+$overhang;
...
FILTER_4_BACK:                  foreach my $line (keys %hash_read_short_start)
                            ...
                            elsif(($count1b+$count2b+$count3b+$count4b) < 10 && $overhang < $read_length-($overlap*1.5) && $before_shorter_skip_back ne "yes")
                            {
                                if ($y > $startprint2)
                                {
                                    print OUTPUT5 "\nMAKE BEFORE SHORTER3\n\n";
...
EXT_BEFORE_BACK:        if ($ext_before eq "yes")
                ...
                if (($extensions_before eq "yes" && $deletion_back ne "yes") || ($indel_split_skip_back ne "yes"  && ($delete_first ne "yes_back" || (length($best_extension1) < 5 && length($best_extension2) < 5)) && $ext_total_back > 18 && $indel_split_back < ($read_length-25 -$overlap)))
                {
                    $best_extension = "";
...
AFTER_EXT_BACK:
            ...
            undef @matches2;
                                            ...
                                            elsif ($use_regex_back ne "yes" && $noback ne "stop")
                                            {                                              
                                                delete $regex_back{$id};
                                                $regex_back{$id} = "yes";
                                                $read_new = $read_new1;
